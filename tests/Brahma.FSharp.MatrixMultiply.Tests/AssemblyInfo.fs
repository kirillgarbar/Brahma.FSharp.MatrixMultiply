...
[<assembly: AssemblyTitleAttribute("Brahma.FSharp.MatrixMultiply.Tests")>]
[<assembly: AssemblyProductAttribute("Brahma.FSharp.MatrixMultiply")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Brahma.FSharp.MatrixMultiply.Tests"
    let [<Literal>] AssemblyProduct = "Brahma.FSharp.MatrixMultiply"
